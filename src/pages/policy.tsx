...
const Policy = () => {
  return (
    <>
      ...
      <Stack spacing={3} w="100%" bg="gray.100" p="100px">
        <Text fontSize="2xl" fontWeight="bold">
          Privacy Policy for Online Presentation Supporter
        </Text>
        <Text fontSize="md">
          At Online Presentation Supporter, accessible from
          https://online-presentation-supporter.vercel.app/, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Online Presentation Supporter and how we use it.
        </Text>
        ...
        <Text fontSize="md">
          ...
          shared and/or collect in Online Presentation Supporter. This policy is
        ...
        <Text fontSize="md">
          Online Presentation Supporter follows a standard procedure of using
        ...
        <Text fontSize="md">
          Like any other website, Online Presentation Supporter uses 'cookies'.
        ...
        <Text fontSize="md">
          ...
          advertising partners of Online Presentation Supporter.
        </Text>
        <Text fontSize="md">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Online Presentation Supporter,
        ...
        <Text fontSize="md">
          Note that Online Presentation Supporter has no access to or control
        ...
        <Text fontSize="md">
          Online Presentation Supporter's Privacy Policy does not apply to other
        ...
        <Text fontSize="md">
          Online Presentation Supporter does not knowingly collect any Personal
